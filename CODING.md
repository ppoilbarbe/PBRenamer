...
│       ├── settings_dialog.ui   Qt Designer source
...
```bash
make ui
# or directly (repeat for each .ui file):
pyside6-uic src/pbrenamer/ui/main_window.ui     -o src/pbrenamer/ui/main_window_ui.py
pyside6-uic src/pbrenamer/ui/about_dialog.ui    -o src/pbrenamer/ui/about_dialog_ui.py
pyside6-uic src/pbrenamer/ui/history_dialog.ui  -o src/pbrenamer/ui/history_dialog_ui.py
pyside6-uic src/pbrenamer/ui/settings_dialog.ui -o src/pbrenamer/ui/settings_dialog_ui.py
```
